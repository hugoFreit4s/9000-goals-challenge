...
type player = {playerName: string, goalsScored: number};
const playersArr: Array<player> = [{playerName: "Cristiano Ronaldo", goalsScored: 763}, {playerName: "Neymar", goalsScored: 360}, {playerName: "Leo Messi", goalsScored: 735}];
